...
int JugadorMaquina::casillasEnDireccion(Direccion dir, int k, int jug){
    ...
    if(dir.x == 0){
        while(dentroBordes(dir.x + multi*Dirs[k].x,dir.y + multi*Dirs[k].y) && tablero->obtenerCasilla(dir.x + multi*Dirs[k].x, dir.y + multi*Dirs[k].y) && multi <=3){
...
int JugadorMaquina::casillasEnDireccion(Direccion dir, int k, int jug){
    ...
    else if(dentroBordes(dir.x+Dirs[k+4].x, dir.y+Dirs[k+4].y) && tablero->obtenerCasilla(dir.x+Dirs[k+4].x,dir.y+Dirs[k+4].y) != jug){
